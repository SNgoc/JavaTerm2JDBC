...
public class Patient {
    ...
    public String toString() {
        SimpleDateFormat sdf = new SimpleDateFormat("DD/MM/YYYY");// tạo set format date cho examdate
        return getID() + " - " + getName() + " - " + (gender ? "Male" : "Female") + " - " + sdf.format(examDate);
    }
    ...
    void input(){
        ...
        while (true) {
            ...
            try {
                gender = Boolean.parseBoolean(sc.nextLine().trim());
                break;
            } catch (Exception e) {
